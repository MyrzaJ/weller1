...
import { BsSearch, BsFacebook, BsTelegram, BsInstagram } from "react-icons/bs";
...
const Burger = () => {
  ...
  return (
    <>
      ...
      <Offcanvas show={show} onHide={handleClose} className="headerDrop">
        <div style={{ background: "#1d1e20" }}>
          <Offcanvas.Header closeButton className="headerDrop">
            <Offcanvas.Title>
              <svg
              ...
              >
                ...
                <path
                  fill="#fff"
                  fill-rule="evenodd"
                  d="M38.5 10.1H47v13.6l7.4-13.6h9L47 40.1h-8.9V27.4l-7 12.7h-8.9v-30h8.9v13.6l7.4-13.6zM86.2 27.5H67c-2.8 8.1 7.7 5.8 9.2 2.3h8.9c-3 6.1-8.1 10.5-16.6 10.4-9.1-.1-12.4-6.7-10.2-15 1.5-5.6 4.9-10.5 10-13 2.9-1.5 6.4-2.1 9.5-1.9 7.4.4 10.3 4.9 9.6 11.7-.2 1.7-.6 3.6-1.2 5.5zm-18-5.3h10.5c3.3-7.8-8.1-6.5-10.5 0zM139.6 27.5h-19.2c-2.8 8.1 7.7 5.8 9.2 2.3h8.9c-3 6.1-8.1 10.5-16.6 10.4-9.1-.1-12.4-6.7-10.2-15 1.5-5.6 4.9-10.5 10-13 2.9-1.5 6.4-2.1 9.5-1.9 7.4.4 10.3 4.9 9.6 11.7-.1 1.7-.6 3.6-1.2 5.5zm-17.9-5.3h10.5c3.2-7.8-8.2-6.5-10.5 0z"
                  clip-rule="evenodd"
                />
                <path
                  fill="#fff"
                  d="M146.2 10.5h9.1l-.6 2.4c2.7-2.5 6.3-3 8.8-2.6l-2.2 8.1c-6-.8-9.4 4.7-10.6 9.1l-3.5 12.8h-9.1l8.1-29.8z"
                />
                <path
                  fill="#fff"
                  fill-rule="evenodd"
                  d="M95.8.3h9L94 40.1h-9.1L95.8.3zM107.2.3h9.1l-10.8 39.8h-9.1L107.2.3z"
                  clip-rule="evenodd"
                />
                <path fill="#F6B200" d="M9.6 10.1H.7v30.1h8.9V10.1z" />
                <path
                  fill="#fff"
                  d="M161.2 31.9c-.8-.8-1.8-1.2-3-1.2s-2.2.5-3 1.2c-.8.8-1.2 1.8-1.2 3s.5 2.2 1.2 3c.8.8 1.8 1.2 3 1.2s2.2-.5 3-1.2c.8-.8 1.2-1.8 1.2-3 .1-1.1-.4-2.2-1.2-3zm-3-2.2c1.4 0 2.7.6 3.7 1.5.9.9 1.5 2.2 1.5 3.7 0 1.4-.6 2.7-1.5 3.7-.9.9-2.2 1.5-3.7 1.5-1.4 0-2.7-.6-3.7-1.5-.9-.9-1.5-2.2-1.5-3.7 0-1.4.6-2.7 1.5-3.7 1-.9 2.3-1.5 3.7-1.5z"
                />
                <path
                  fill="#fff"
          ...
          <div style={{ background: "#1d1e20" }}>
            <Offcanvas.Body className="headerDrop">
              <div style={{ background: "#1d1e20", color: "white" }}>
                <br />
                <br />
                <h6>Weller – Дистрибьюторский центр</h6>
                <hr />
                <h6>Магазин</h6>
                <hr />
                <h6>О нас</h6>
